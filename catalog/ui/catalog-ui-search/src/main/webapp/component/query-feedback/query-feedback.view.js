...
module.exports = Marionette.LayoutView.extend({
    ...
    edit: function(){
        ...
        var tabable =  _.filter(this.$el.find('[tabindex], input, button, textarea'), function(element){
    ...
    handleSend: function(){
        var payload = {
            ...
            workspaceId: store.getCurrentWorkspace().id,
            comments: this.comments.currentView.getCurrentValue()[0]
        };
        // submit payload to endpoint, no need to have a loading symbol since it's async
    }
});