...
define([
    ...
    return Marionette.LayoutView.extend({
        ...
        regions: {
            propertyResultCount: '.properties-resultCount'
        },
        ...
        setupResultCount: function () {
            ...
            this.propertyResultCount.show(new PropertyView({
                model: new Property({
                    label: 'Number of Results Per Source',
            ...
            this.propertyResultCount.currentView.$el.on('change', this.saveChanges.bind(this));
        },
