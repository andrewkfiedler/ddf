...
const routeDefinitions = {
    ...plugin({
        ...
        openIngest: {
            ...
            menu: {
                component: require('component/ingest-menu/ingest-menu.view')
            }
        },
        openUpload: {
            patterns: ['uploads/:id'],
        ...
        openSources: {
            ...
            menu: {
                component: require('component/sources-menu/sources-menu.view')
            }
        },
        openAbout: {
            patterns: ['about(/)'],
            ...
            menu: {
                component: require('component/about-menu/about-menu.view')
            }
        }
    }),
